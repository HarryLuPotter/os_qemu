...
static void cputch(int c, int *cnt) {
    ...
    cons_putc(c);
    8020005a:	122000ef          	jal	ra,8020017c <cons_putc>
    (*cnt)++;
...
void clock_init(void) {
    ...
    // trigger
    __asm__ volatile (
    80200134:	9002                	ebreak
    80200136:	30200073          	mret
        "ebreak\n"
        "mret\n"
    );
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    cprintf("++ setup timer interrupts\n");
    80200166:	f07ff06f          	j	8020006c <cprintf>
...
void print_regs(struct pushregs *gpr) {
    ...
    80200360:	c3c50513          	addi	a0,a0,-964 # 80200f98 <etext+0x522>
}
    80200364:	0141                	addi	sp,sp,16
    cprintf("  t6       0x%08x\n", gpr->t6);
    80200366:	d07ff06f          	j	8020006c <cprintf>
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200376:	c3e50513          	addi	a0,a0,-962 # 80200fb0 <etext+0x53a>
void print_trapframe(struct trapframe *tf) {
    ...
    8020038e:	c3e50513          	addi	a0,a0,-962 # 80200fc8 <etext+0x552>
    80200392:	cdbff0ef          	jal	ra,8020006c <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
    80200396:	10843583          	ld	a1,264(s0)
    8020039a:	00001517          	auipc	a0,0x1
    8020039e:	c4650513          	addi	a0,a0,-954 # 80200fe0 <etext+0x56a>
    802003a2:	ccbff0ef          	jal	ra,8020006c <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
    802003a6:	11043583          	ld	a1,272(s0)
    802003aa:	00001517          	auipc	a0,0x1
    802003ae:	c4e50513          	addi	a0,a0,-946 # 80200ff8 <etext+0x582>
    802003b2:	cbbff0ef          	jal	ra,8020006c <cprintf>
    cprintf("  cause    0x%08x\n", tf->cause);
    ...
    802003c2:	c5250513          	addi	a0,a0,-942 # 80201010 <etext+0x59a>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003f2:	87250513          	addi	a0,a0,-1934 # 80200c60 <etext+0x1ea>
    802003f6:	c77ff06f          	j	8020006c <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003fa:	00001517          	auipc	a0,0x1
    802003fe:	84650513          	addi	a0,a0,-1978 # 80200c40 <etext+0x1ca>
    80200402:	c6bff06f          	j	8020006c <cprintf>
            cprintf("User software interrupt\n");
    80200406:	00000517          	auipc	a0,0x0
    8020040a:	7fa50513          	addi	a0,a0,2042 # 80200c00 <etext+0x18a>
    8020040e:	c5fff06f          	j	8020006c <cprintf>
            cprintf("Supervisor software interrupt\n");
    80200412:	00001517          	auipc	a0,0x1
    80200416:	80e50513          	addi	a0,a0,-2034 # 80200c20 <etext+0x1aa>
    8020041a:	c53ff06f          	j	8020006c <cprintf>
            break;
        case IRQ_U_EXT:
            cprintf("User software interrupt\n");
            break;
    ...
    80200422:	87250513          	addi	a0,a0,-1934 # 80200c90 <etext+0x21a>
    80200426:	c47ff06f          	j	8020006c <cprintf>
void interrupt_handler(struct trapframe *tf) {
    ...
    80200476:	80e50513          	addi	a0,a0,-2034 # 80200c80 <etext+0x20a>
    8020047a:	bf3ff0ef          	jal	ra,8020006c <cprintf>
            	++num;
...
void exception_handler(struct trapframe *tf) {
    ...
    802004d8:	b95ff0ef          	jal	ra,8020006c <cprintf>
            cprintf("exception address: %x\n",tf->epc);
    802004dc:	10843583          	ld	a1,264(s0)
    802004e0:	00000517          	auipc	a0,0x0
    802004e4:	6f850513          	addi	a0,a0,1784 # 80200bd8 <etext+0x162>
    802004e8:	b85ff0ef          	jal	ra,8020006c <cprintf>
            tf->epc+=4;
    ...
    80200502:	6f250513          	addi	a0,a0,1778 # 80200bf0 <etext+0x17a>
    80200506:	b67ff0ef          	jal	ra,8020006c <cprintf>
            cprintf("exception address: %x\n",tf->epc);
    8020050a:	10843583          	ld	a1,264(s0)
    8020050e:	00000517          	auipc	a0,0x0
    80200512:	6ca50513          	addi	a0,a0,1738 # 80200bd8 <etext+0x162>
    80200516:	b57ff0ef          	jal	ra,8020006c <cprintf>
            tf->epc+=2;
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200634:	b8878793          	addi	a5,a5,-1144 # 802011b8 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200688:	9a0a0a13          	addi	s4,s4,-1632 # 80201024 <etext+0x5ae>
    ...
    80200694:	af0c0c13          	addi	s8,s8,-1296 # 80201180 <error_string>
    ...
    80200782:	aea60613          	addi	a2,a2,-1302 # 80201268 <error_string+0xe8>
    ...
    80200916:	94660613          	addi	a2,a2,-1722 # 80201258 <error_string+0xd8>
    ...
    80200928:	92c60613          	addi	a2,a2,-1748 # 80201250 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    8020092c:	00001417          	auipc	s0,0x1
    80200930:	92540413          	addi	s0,s0,-1755 # 80201251 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009bc:	89940413          	addi	s0,s0,-1895 # 80201251 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
